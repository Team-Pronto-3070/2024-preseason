//thanks to team 95 for this implementation
//source: https://github.com/first95/FRC2023/blob/main/2023robot/src/main/java/frc/lib/util/BetterSwerveKinematics.java
 ...
 * <p></p>
 *
 * Makes use of {@link SwerveModuleState2} to add the angular
 * velocity that is required of the module as an output.
 */
public class SwerveDriveKinematics2 extends SwerveDriveKinematics {
     ...
     *     attainable max velocity. Use the {@link #desaturateWheelSpeeds(SwerveModuleState2[], double)
