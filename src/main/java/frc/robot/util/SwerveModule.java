...
public class SwerveModule {
    ...
    public void setDesiredState(SwerveModuleState2 rawDesiredState, boolean isOpenLoop) {
        ...
        if (isOpenLoop) {
            driveMotor.set(ControlMode.PercentOutput,
                    optimizedDesiredState.speedMetersPerSecond / Constants.Swerve.maxSpeed);
        } else {
            ...
            driveMotor.set(ControlMode.Velocity, sensorCounts,
                    ...
                    driveFeedforward.calculate(optimizedDesiredState.speedMetersPerSecond));
        }
    ...
    public SwerveModulePosition getPosition() {
        return new SwerveModulePosition(
                driveMotor.getSelectedSensorPosition() * Constants.Swerve.wheelCircumference
